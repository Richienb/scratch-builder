...
module.exports = async ({ title, buildDirectory, width }) => {
...
nw.App.registerGlobalHotKey(new nw.Shortcut({
  ...
  active: () => {
	...
	await createWindowsInstaller({
		...
		authors: "My App Inc.", // TODO: Use author from project page.
		exe: `${title}.exe`,
		title,
		usePackageJson: false,
		version: "1.0.0",
		name: "ScratchBuilder",
		description: "A Scratch game.", // TODO: Use description from project page.
